...
##############################################################
#  I will not be generating images, and including these
# classes would require more modules not included in Anki.
##############################################################
...
FORMATTERS = {
    ...
    # Lines commented out for the same reason as before
